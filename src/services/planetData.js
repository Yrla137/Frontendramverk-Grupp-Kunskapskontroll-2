const planets = [
  {
    ...
    facts: [
      ...
      { label: "Light Travel to Earth", value: "8 minutes 20 seconds" },
      { label: "Rotation Period", value: "25-35 days" },
    ],
    explored: true,
    quizCompleted: false,
  },
  {
    ...
    facts: [
      ...
      { label: "Orbital Speed", value: "47.36 km/s (fastest planet)" },
      { label: "Surface Gravity", value: "38% of Earth" },
      { label: "Atmosphere", value: "Almost none (exosphere)" },
      { label: "Core", value: "Iron core ~75% of radius" },
    ],
    explored: true,
    quizCompleted: true,
  },
  {
    ...
    facts: [
      ...
      { label: "Rotation", value: "Retrograde (spins backwards)" },
      { label: "Surface Pressure", value: "90x Earth (crushes metal)" },
      { label: "Volcanoes", value: "Over 1,600 known" },
    ],
    explored: false,
    quizCompleted: false,
  },
  {
    ...
    facts: [
      ...
      { label: "Atmosphere", value: "78% Nitrogen, 21% Oxygen" },
      { label: "Orbital Speed", value: "107,000 km/h" },
    ],
    explored: true,
    quizCompleted: false,
  },
  {
    ...
    facts: [
      ...
      { label: "Longest Valley", value: "Valles Marineris (4,000 km)" },
      { label: "Surface Gravity", value: "38% of Earth" },
      { label: "Atmosphere", value: "95% Carbon Dioxide" },
    ],
    explored: true,
    quizCompleted: true,
  },
  {
    ...
    facts: [
      ...
      { label: "Magnetic Field", value: "20,000x stronger than Earth" },
      { label: "Largest Moon", value: "Ganymede (bigger than Mercury)" },
      { label: "Composition", value: "90% Hydrogen, 10% Helium" },
      { label: "Ring System", value: "4 faint rings" },
    ],
    explored: false,
    quizCompleted: false,
  },
  {
    ...
    facts: [
      ...
      { label: "Largest Moon", value: "Titan (has thick atmosphere)" },
      { label: "Ring Composition", value: "Mostly ice and rock" },
      { label: "Hexagonal Storm", value: "Persistent storm at north pole" },
    ],
    explored: false,
    quizCompleted: false,
  },
  {
    ...
    facts: [
      ...
      { label: "Temperature", value: "-224°C (coldest planet)" },
      { label: "Discovered", value: "1781 by William Herschel" },
      { label: "Ring System", value: "13 known rings" },
  ...
  },
  {
    ...
    facts: [
      ...
      { label: "Discovery", value: "1846 (predicted mathematically)" },
      { label: "Largest Moon", value: "Triton (orbits backwards)" },
      { label: "Temperature", value: "-214°C" },
      { label: "Great Dark Spot", value: "Storm system like Jupiter" },
    ],
    explored: false,
    quizCompleted: false,
  },
  {
    ...
    facts: [
      ...
      { label: "Reclassified", value: "2006 (formerly 9th planet)" },
      { label: "Discovered", value: "1930 by Clyde Tombaugh" },
      { label: "Heart Feature", value: "Tombaugh Regio (nitrogen ice)" },
      { label: "First Flyby", value: "New Horizons (2015)" },
    ],
    explored: false,
    quizCompleted: false,
  },
  {
    ...
    facts: [
      ...
      { label: "Temperature Range", value: "-173°C to 127°C" },
      { label: "Tidally Locked", value: "Same side always faces Earth" },
      { label: "Formation", value: "Giant impact theory (Theia)" },
      { label: "Moonwalkers", value: "12 astronauts total" },
    ],
    explored: false,
    quizCompleted: false,
  },
  {
    ...
    facts: [
      ...
      { label: "Width", value: "~150 million km" },
      { label: "Ceres Status", value: "Dwarf planet since 2006" },
      { label: "Composition Types", value: "Carbon, Silicate, Metal" },
      { label: "Average Spacing", value: "Millions of km apart" },
    ],
    explored: false,
    quizCompleted: false,
  },
